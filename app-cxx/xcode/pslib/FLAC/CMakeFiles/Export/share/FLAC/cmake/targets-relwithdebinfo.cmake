...
# Import target "FLAC::flacapp" for configuration "RelWithDebInfo"
set_property(TARGET FLAC::flacapp APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(FLAC::flacapp PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/flac"
  )

list(APPEND _IMPORT_CHECK_TARGETS FLAC::flacapp )
list(APPEND _IMPORT_CHECK_FILES_FOR_FLAC::flacapp "${_IMPORT_PREFIX}/bin/flac" )

# Import target "FLAC::metaflac" for configuration "RelWithDebInfo"
set_property(TARGET FLAC::metaflac APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(FLAC::metaflac PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/metaflac"
  )
